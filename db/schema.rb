...
ActiveRecord::Schema.define(version: 20180102131153) do
  ...
  create_table "videos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "for_upwork",                         default: false
    t.index ["created_at"], name: "index_videos_on_created_at", using: :btree
    t.index ["height"], name: "index_videos_on_height", using: :btree
    t.index ["length"], name: "index_videos_on_length", using: :btree
    t.index ["sid"], name: "index_videos_on_sid", using: :btree
    t.index ["slug"], name: "index_videos_on_slug", using: :btree
    t.index ["title"], name: "index_videos_on_title", using: :btree
    t.index ["views"], name: "index_videos_on_views", using: :btree
  end
